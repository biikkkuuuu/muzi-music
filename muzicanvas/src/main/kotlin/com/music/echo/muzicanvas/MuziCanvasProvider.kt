package com.biikkkuuuu.muzi.muzicanvas
...
@Serializable
data class muziCanvasManifest(
    val items: List<muziCanvasItem> = emptyList()
)

@Serializable
data class muziCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object muziCanvasProvider {
    ...
    private suspend fun fetchManifest(): muziCanvasManifest? {
        ...
        return try {
            val manifest: muziCanvasManifest = client.get(BASE_URL).body()
