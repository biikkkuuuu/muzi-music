...
class CipherWebView private constructor(
    ...
    // carry a per-request id, ed back by the JS bridge: a late result from a cancelled/
     ...
     * JS call must  back; takeIfCurrent(id) ignores late callbacks from superseded
