...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.biikkkuuuu.muzi.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.biikkkuuuu.muzi.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.biikkkuuuu.muzi.widget.recognizer.RESET"
    }
}
