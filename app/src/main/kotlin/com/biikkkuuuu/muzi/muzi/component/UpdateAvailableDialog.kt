package com.biikkkuuuu.muzi.muzi.component
...
import com.biikkkuuuu.muzi.muzi.updater.ChangelogSection
            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            onDismiss()
                            val intent = Intent(Intent.ACTION_VIEW, android.net.Uri.parse("https://muzi.fun"))
