...
package com.biikkkuuuu.muzi.muzi.updater
...
import com.biikkkuuuu.muzi.muzi.updater.downloadmanager.UpdateDownloadWorker
import com.biikkkuuuu.muzi.muzi.updater.downloadmanager.DownloadNotificationManager
...
fun UpdateScreen(navController: NavHostController) {
            ...
            checkForUpdate(
                ...
                onSuccess = { tag, isAvailable, changelog, size, date, description, imageUrl, apkUrl ->
                    ...
                    status = if (isAvailable) {
                        ...
                        UpdateStatus.NoUpdate(tag)
                    }
                },
                onError = {
                    status = UpdateStatus.Error(context.getString(R.string.cant_check_updates))
                }
            )
        }
    }
    ...
    Scaffold(
        topBar = {
            LargeTopAppBar(
                title = {
                    val titleText = if (status is UpdateStatus.Available) {
                        buildAnnotatedString {
                            ...
                            withStyle(
                                ...
                                append((status as UpdateStatus.Available).version)
                            }
                        }
                    } else {
        ...
        Box(
            ...
            LazyColumn(
                ...
                item {
                    val contentModifier = if (status is UpdateStatus.Available) {
